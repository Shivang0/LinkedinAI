...
export const metadata = {
  title: 'Terms & Conditions - LinAI',
  description: 'Terms and Conditions for LinAI - AI-powered LinkedIn content creation',
};
    ...
    <div className="min-h-screen bg-[#1a1c2c] py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-3xl mx-auto relative z-10">
        ...
        <div className="flex items-center gap-4 mb-8">
          <div
            className="w-12 h-12 bg-[#63c74d] border-4 border-[#f4f4f4] flex items-center justify-center"
            style={{ boxShadow: '4px 4px 0 #0a0a0f' }}
          >
            <FileText className="w-6 h-6 text-[#f4f4f4]" />
          </div>
        ...
        >
          ...
          <Section title="1. Authentication">
            <p>Users must sign in only via LinkedIn OAuth.</p>
          </Section>

          <Section title="2. Use of Service">
            <p>Users must use LinAI ethically and legally.</p>
          </Section>

          <Section title="3. AI Content">
            <p>Users are responsible for verifying AI-generated content before posting.</p>
          </Section>
          ...
          <Section title="5. Liability">
            <p>LinAI is not responsible for losses from incorrect AI outputs, LinkedIn restrictions, or downtime.</p>
          </Section>

          <Section title="6. Termination">
            <p>Accounts may be terminated for misuse or non-payment.</p>
          </Section>
